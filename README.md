...
[Spack](https://spack.io) is a package manager for *supercomputers*. It is commonly used in high-performance computing (HPC) environments of all scales: examples include [kinetic and gyrokinetic problems on exascale architectures](https://gyselax.github.io/), AI inference stacks on smaller clusters or even local development environments.
...
generation of such Spack recipes, and 2) to assist in the identification and creation of test scenarios to ensure the quality of the produced recipes.
...
- Familiarization with Spack’s packaging practices
- Identification of existing generative AI tools
- Summarization of strategies for generative-AI assisted recipe generation
- Design and implementation of a solution for generative-AI assisted recipe generation
- Test the design in the context of complex software stacks like Gysela or vLLM
- Develop a methodology to validate the effectiveness of generated recipes
